	...
	<div class="cart-items">
		<div class="container">
				...
				<div class="cart-header col-md-6">
					<div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							<a href="<c:url value="/goods_detail?id=${item.key}"/>">
								<img src="${pageContext.request.contextPath }${item.value.goods.cover}" class="img-responsive" alt="图片加载失败" >
							</a>
						</div>
						<div class="cart-item-info">
							<h3><a href="<c:url value="/goods_detail?id=${item.key}"/>">${item.value.goods.name}</a></h3>
			...
			<div class="cart-header col-md-12">
				...
				<a class="btn btn-success btn-lg" style="margin-left:74%" href="<c:url value="/order_submit"/>">提交订单</a>
			</div>
		</div>
	</div>
	<!--//cart-items-->
