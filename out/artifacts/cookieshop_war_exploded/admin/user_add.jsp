...
<div class="container-fluid">
	...
	<br><br>
	<form class="form-horizontal" action="<c:url value="/admin/user_add"/>" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_mail" name="email" required="required" value="${u.email }"/>
			</div>
		</div>
		<div class="form-group">
